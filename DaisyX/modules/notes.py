...
Also notes perfectly working in PM with TeamDaisyX's Daisy-X.
...
TeamDaisyX's Daisy-X can save notes from other bots, just reply /save on the saved message from another bot, saving pictures and buttons supported aswell.
