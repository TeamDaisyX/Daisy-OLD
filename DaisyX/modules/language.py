...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    # markup.add(InlineKeyboardButton(
        # strings['crowdin_btn'], url='https://crowdin.com/project/DaisyX'))
    if edit:
        markup.add(InlineKeyboardButton(
...
__help__ = """
Get the available list of language in DaisyXBot by below commands.
...
DaisyXBot will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
